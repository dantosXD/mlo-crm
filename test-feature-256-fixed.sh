...
echo "Step 4: Creating DRAFT communication..."
...
echo "Step 5: Testing PATCH /status (DRAFT -> READY)..."
...
echo "Step 6: Testing invalid transition (READY -> DRAFT)..."
...
echo "Step 7: Testing POST /send endpoint..."
...
echo "Step 8: Testing that SENT cannot transition..."
...
echo "Step 9: Testing transition to FAILED..."
